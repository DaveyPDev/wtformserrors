...
class EmployeeForm(FlaskForm):
    ...
    name = StringField("Employee Name", validators=[InputRequired['Name not be blank']])
    state = StringField("State", choices=[(st,st) for st in states])
    dept_code = StringField("Department Code", choices=[('mktg')])